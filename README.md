...
- **Plan month / Actual date** — Plan stages use an optional month picker prefilled from the clicked grid month; if cleared, the stage stays in the clicked month. Actual stages require a full date, default to day `01` in the clicked month, and are placed in that date's month.
